...
public class P02_dataTypes {public static void main(String[] args) {
    ...
    System.out.println("Byte  Max. Değer = " + b1); //127
    System.out.println("Byte  Min. Değer = " + b2); //-128
    short s1 = Short.MAX_VALUE; //
    short s2 = Short.MIN_VALUE;
    System.out.println("Short  Max. Değer = " + s1); //32767
    System.out.println("Short  Min. Değer= " + s2);
    int i1 = Integer.MAX_VALUE;
    int i2 = Integer.MIN_VALUE;
    System.out.println("Integer  Max. Değer  = " + i1);//2147483647
